...
import { MAXIMUM_CHARACTERS_DESCRIPTION, MAXIMUM_CHARACTERS_NAME, MINIMUM_CHARACTERS_DESCRIPTION, MINIMUM_CHARACTERS_NAME } from '@Constants/poultry'
...
export const storePoultrySchema = Joi.object({
  ...
  address: Joi.object({
    ...
    number: Joi.number().required().messages({
      'string.empty': i18n.__('empty-field', { field: i18n.__('poultry.fields.address.number') }),
